...
import { RehberDonenKenarlik } from '@/admin/kabuk/ortak/RehberDonenKenarlik';
...
export function AdminRehberModal({
  ...
  return (
    <div className="ap-rehber-overlay" role="dialog" aria-modal="true" aria-labelledby="rehber-baslik">
      ...
      <div className="ap-rehber-modal-wrap">
        <RehberDonenKenarlik />
        <div className="ap-rehber-modal ap-rehber-modal--donen-kenarlik">
