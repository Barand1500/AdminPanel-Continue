...
export const HEADER_TIP_DEMO: Record<HeaderTipi, HeaderTipDemoPaket> = {
  ...
  'cta-serit': {
    markaMetni: 'NOVA STUDIO',
    slogan: 'Yeni koleksiyon ve özel teklifleri keşfedin',
    telefon: '+90 212 555 41 10',
    email: 'merhaba@nova-ornek.com',
    anaRenk: '#6d28d9',
    ikincilRenk: '#f59e0b',
    aramaPlaceholder: 'Ara',
    ornekNotu: 'Duyuru şeridi ve belirgin çağrı aksiyonlu kurumsal örnek — sahte marka',
    menu: menu([
      { baslik: 'Çözümler' },
      { baslik: 'Çalışmalar' },
      { baslik: 'Kaynaklar' },
  ...
  'sosyal-sahne': {
    markaMetni: 'ATÖLYE 34',
    slogan: 'Fikirleri görünür deneyimlere dönüştürüyoruz',
    telefon: '+90 216 555 34 34',
    email: 'merhaba@atolye34-ornek.com',
    anaRenk: '#0f766e',
    ikincilRenk: '#fbbf24',
    aramaPlaceholder: 'Ara',
    ornekNotu: 'Sosyal bağlantıları merkeze alan yaratıcı stüdyo örneği — sahte marka',
    menu: menu([
      { baslik: 'Projeler' },
      { baslik: 'Hizmetler' },
      { baslik: 'Günlük' },
  ...
  kartlar: {
    markaMetni: 'LUMA',
    slogan: 'Dijital ürünler için net ve hızlı çözümler',
    telefon: '+90 850 555 12 12',
    email: 'hello@luma-ornek.com',
    anaRenk: '#1e293b',
    ikincilRenk: '#38bdf8',
    aramaPlaceholder: 'Ara',
    ornekNotu: 'Kart görünümlü menü bağlantılarıyla modern ürün vitrini — sahte marka',
    menu: menu([
      { baslik: 'Ürün' },
      { baslik: 'Çözümler' },
      { baslik: 'Fiyatlar' },
