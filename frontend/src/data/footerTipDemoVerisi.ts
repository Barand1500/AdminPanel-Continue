...
export const FOOTER_TIP_DEMO: Record<FooterTipi, FooterTipDemoPaket> = {
  ...
  split: {
    ...
    whatsapp: '',
    telifYazisi: '© 2026 Flowbase — Tüm hakları saklıdır. (Örnek)',
    ornekNotu: 'Stripe tarzı split vitrin footer örneği',
    sosyalMedya: { twitter: '#', linkedin: '#', github: '#' },
    kolonlar: [
      kolon('k1', 'Ürün', [
        { ad: 'Özellikler', link: '#' },
        { ad: 'Fiyatlandırma', link: '#' },
  ...
  'cta-serit': {
    ...
    adres: '',
    telefon: '',
    email: 'merhaba@studionorth-ornek.com',
    whatsapp: '',
    telifYazisi: '© 2026 StudioNorth. (Örnek)',
    ornekNotu: 'Webflow tarzı çağrı bandı footer örneği',
    sosyalMedya: { instagram: '#', dribbble: '#' },
    kolonlar: [
      kolon('k1', '', [
        { ad: 'İşler', link: '#' },
        { ad: 'Hizmetler', link: '#' },
  ...
  'sosyal-sahne': {
    ...
    email: '',
    whatsapp: '',
    telifYazisi: '© 2026 ATELIER NOIR. (Örnek)',
    ornekNotu: 'Ajans tarzı sosyal sahne footer örneği',
    sosyalMedya: {
      instagram: '#',
      behance: '#',
      dribbble: '#',
  ...
  kartlar: {
    siteAdi: 'Lumen Studio',
    anaRenk: '#2563eb',
    ikincilRenk: '#93c5fd',
    adres: 'Kadıköy, İstanbul',
    telefon: '+90 216 555 0303',
    email: 'selam@lumen-ornek.com',
    whatsapp: '',
    telifYazisi: '© 2026 Lumen Studio — Tüm hakları saklıdır. (Örnek)',
    ornekNotu: 'Kart ızgara footer örneği — sahte stüdyo',
    sosyalMedya: { linkedin: '#', instagram: '#' },
    kolonlar: [
      kolon('k1', 'Hizmetler', [
        { ad: 'Marka', link: '#' },
        { ad: 'Web', link: '#' },
  ...
  'split-vitrin': {
    ...
    ikincilRenk: '#c9a227',
    adres: 'Nişantaşı, İstanbul',
    telefon: '0212 000 11 22',
    email: 'merhaba@vitrin-ornek.com',
    whatsapp: '+905551000111',
    telifYazisi: '© 2026 Vitrin — Tüm hakları saklıdır. (Örnek)',
    ornekNotu: 'İki panelli mağaza footer örneği',
    sosyalMedya: { instagram: '#', facebook: '#' },
    kolonlar: [
      kolon('k1', 'Koleksiyon', [
        { ad: 'Yeni Sezon', link: '#' },
      ...
      kolon('k2', 'Mağaza', [
        { ad: 'Mağazalar', link: '#' },
        { ad: 'Randevu', link: '#' },
        { ad: 'Hediye Kartı', link: '#' },
      ]),
    ],
    pazaryeri: [{ id: 'p1', ad: 'Trendyol', link: '#', aktif: true, sira: 0 }],
    rozetler: [{ id: 'r1', ikon: '🔒', metin: 'SSL', aktif: true, sira: 0 }],
  },
  yuzen: {
    siteAdi: 'Aura',
    anaRenk: '#111827',
    ...
    email: 'selam@aura-ornek.com',
    whatsapp: '+905552223344',
    telifYazisi: '© 2026 Aura — Tüm hakları saklıdır. (Örnek)',
    ornekNotu: 'Yüzen kart footer örneği',
    sosyalMedya: { instagram: '#', twitter: '#' },
    kolonlar: [
      kolon('k1', 'Keşfet', [
        { ad: 'Hikaye', link: '#' },
  ...
  masthead: {
    siteAdi: 'Atlas Holding',
    anaRenk: '#0b2a77',
    ikincilRenk: '#c5a46e',
    adres: 'Levent, İstanbul',
    telefon: '0212 333 44 55',
    email: 'info@atlas-ornek.com',
    whatsapp: '+905553334455',
    telifYazisi: '© 2026 Atlas Holding — Tüm hakları saklıdır. (Örnek)',
    ornekNotu: 'Masthead kurumsal footer örneği',
    sosyalMedya: { linkedin: '#', twitter: '#' },
    kolonlar: [
      kolon('k1', 'Grup', [
        { ad: 'Hakkımızda', link: '#' },
        { ad: 'Yönetim', link: '#' },
        { ad: 'Sürdürülebilirlik', link: '#' },
      ]),
      kolon('k2', 'Yatırımcı', [
        { ad: 'Raporlar', link: '#' },
        { ad: 'Duyurular', link: '#' },
      ...
      kolon('k3', 'Kariyer', [
        { ad: 'Açık Pozisyonlar', link: '#' },
        { ad: 'Staj', link: '#' },
        { ad: 'Başvuru', link: '#' },
      ]),
    ],
    pazaryeri: [],
    rozetler: [{ id: 'r1', ikon: '🛡️', metin: 'ISO 27001', aktif: true, sira: 0 }],
  },
  'cam-panel': {
    siteAdi: 'Lumina',
    anaRenk: '#0f172a',
    ...
    email: 'hello@lumina-ornek.com',
    whatsapp: '+905554445566',
    telifYazisi: '© 2026 Lumina — Tüm hakları saklıdır. (Örnek)',
    ornekNotu: 'Cam panel footer örneği',
    sosyalMedya: { instagram: '#', twitter: '#' },
    kolonlar: [
      kolon('k1', 'Stüdyo', [
        { ad: 'Projeler', link: '#' },
