...
export const HEADER_TIP_TANIMLARI: HeaderTipTanimi[] = [
  ...
  { id: 'sade', ad: 'Sade', aciklama: 'Tek satır, minimal, arama ikon', ilham: 'Apple', ustBant: false, kategoriArama: true, ekAyarlari: true },
  { id: 'kompakt', ad: 'Kompakt', aciklama: 'Düşük yükseklik, sıkışık düzen', ilham: 'Nike', ustBant: false, kategoriArama: true, ekAyarlari: true },
  ...
  { id: 'seffaf-hero', ad: 'Şeffaf Hero', aciklama: 'Scroll öncesi şeffaf header', ilham: 'Tesla', ustBant: false, kategoriArama: false, ekAyarlari: true },
...
export function varsayilanTipEk(tip: HeaderTipi): HeaderTipEkAyarlari {
  ...
  switch (tip) {
    ...
    case 'seffaf-hero': return { ...ortak, seffafBaslangic: true, aramaModu: 'ikon' };
