...
export const adminModulleri: AdminModul[] = [
  ...
  { id: 'slider-yonetimi', baslik: 'Banner Yönetimi', ikon: '🎠', kategori: 'Hızlı Erişim', yol: '/gt-admin/sliderlar' },
  ...
  { id: 'kategoriler', baslik: 'Menü Yönetimi', ikon: '📂', kategori: 'Site Yönetimi', yol: '/gt-admin/kategoriler' },
