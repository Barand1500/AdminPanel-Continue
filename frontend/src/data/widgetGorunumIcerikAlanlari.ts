...
export const WIDGET_GORUNUM_ICERIK_ALANLARI: Record<string, WidgetIcerikAlanHaritasi> = {
  ...
  BLOG_KARUSEL: {
    _varsayilan: ['baslik', 'altBaslik', 'tumunuGor'],
    'snap-serit': ['baslik', 'altBaslik', 'tumunuGor'],
    'hero-mini-grid': ['baslik', 'altBaslik', 'tumunuGor'],
    'sekmeli-kategori': ['baslik', 'altBaslik', 'filtreler', 'tumunuGor'],
    'overlay-sinematik': ['baslik', 'altBaslik', 'tumunuGor'],
    'ticker-hero': ['baslik', 'altBaslik', 'tumunuGor'],
  },
  EKIP_KARUSEL: {
  ...
  GALERI: {
    _varsayilan: ['baslik', 'altBaslik', 'aciklama'],
    'snap-yatay-serit': ['baslik', 'altBaslik', 'aciklama'],
    'hero-vitrin': ['baslik', 'altBaslik', 'aciklama', 'heroBannerMetin'],
    'lightbox-odak': ['baslik', 'altBaslik', 'aciklama'],
    'sekmeli-kategori': ['baslik', 'altBaslik', 'aciklama', 'filtreler'],
    'hover-zoom-etiket': ['baslik', 'altBaslik', 'aciklama'],
    'karusel-merkez': ['baslik', 'altBaslik', 'aciklama'],
  },
  HARITA: {
    _varsayilan: ['baslik'],
    ...
    'yan-ikon-liste': ['baslik', 'altBaslik', 'aciklama'],
  ...
  SSS: {
    ...
    'sekmeli-kategori': ['baslik', 'altBaslik', 'filtreler'],
    'arama-filtre': ['baslik', 'altBaslik', 'aciklama'],
    'tek-acik-odak': ['baslik', 'altBaslik'],
    'kart-destesi': ['baslik', 'altBaslik', 'aciklama'],
    'yan-menu-icerik': ['baslik', 'altBaslik', 'solBaslik'],
  },
  POPUP: {
  ...
  GORSEL_ETIKET_KARTLARI: {
    ...
    'masonry-galeri': ['baslik', 'altBaslik'],
    'flip-kart': ['baslik', 'altBaslik'],
  },
  BASLIK_METIN_GORSEL: {
