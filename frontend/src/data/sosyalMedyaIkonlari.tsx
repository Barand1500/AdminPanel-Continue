  ...
  switch (platform) {
    ...
    case 'facebook':
      return (
        <path
          fill={fill}
          d="M14.5 8h-2.25c-.69 0-1.25.56-1.25 1.25V11H8.5v3h2.75v8.25h4.25v-8.25h2.75l.45-2.75H15.25V10c0-.69-.56-1.25-1.25-1.25H14.5V8z"
        />
      );
    case 'threads':
      return (
        <path
          fill={fill}
          d="M12.186 24h-.007c-3.581-.024-6.334-1.205-8.184-3.509C2.35 18.44 1.5 15.586 1.472 12.01v-.017c.03-3.579.879-6.43 2.525-8.482C5.845 1.205 8.6.024 12.18 0h.014c2.746.02 5.043.725 6.826 2.098 1.677 1.29 2.858 3.13 3.509 5.467l-2.04.569c-.584-2.043-1.505-3.528-2.85-4.62-1.42-1.093-3.202-1.646-5.303-1.67-2.93.033-5.11 1.013-6.484 2.913-1.305 1.81-1.96 4.367-1.948 7.6.012 3.234.655 5.79 1.96 7.6 1.374 1.9 3.554 2.88 6.484 2.913 2.101-.024 3.883-.577 5.303-1.67 1.345-1.092 2.266-2.577 2.85-4.62l2.04.569c-.651 2.337-1.832 4.177-3.509 5.467-1.783 1.373-4.08 2.078-6.826 2.098z"
        />
      );
    case 'medium':
      return (
    ...
    case 'snapchat':
      return (
        <path
          fill={fill}
          d="M12 3c2.8 0 4.5 1.35 4.5 4.05 0 1-.15 2.1-.25 2.85-.1.6.45 1 .95 1.25.6.3 1.25.55 1.25 1.1 0 .45-.35.75-.85.95-.25.1-.55.2-.85.3-.45.15-.85.4-.95.75-.05.2 0 .4.15.55.25.25.7.45 1.25.7.95.45 1.55.9 1.55 1.55 0 .65-.55 1.15-1.5 1.15-.3 0-.65-.03-1-.08a18 18 0 0 1-1.05-.18c-.45-.08-.9-.16-1.35-.16-.4 0-.85.08-1.3.16-.35.06-.7.13-1.05.18-.35.05-.7.08-1 .08-.95 0-1.5-.5-1.5-1.15 0-.65.6-1.1 1.55-1.55.55-.25 1-.45 1.25-.7.15-.15.2-.35.15-.55-.1-.35-.5-.6-.95-.75-.3-.1-.6-.2-.85-.3-.5-.2-.85-.5-.85-.95 0-.55.65-.8 1.25-1.1.5-.25 1.05-.65.95-1.25-.1-.75-.25-1.85-.25-2.85C7.5 4.35 9.2 3 12 3z"
        />
      );
    default:
      return null;
