...
const IKON_KELIMELERI: Array<{ anahtarlar: string[]; ikon: CizgiIkonYedegi }> = [
  { anahtarlar: ['mutlu', 'musteri', 'müşteri', 'memnun', 'kalp', 'heart'], ikon: 'memnuniyet' },
  ...
  { anahtarlar: ['urun', 'ürün', 'hedef', 'target', 'hizmet'], ikon: 'hedef' },
  { anahtarlar: ['destek', 'support', 'yardim', 'yardım', 'kulaklik', 'kulaklık'], ikon: 'destek' },
  ...
  { anahtarlar: ['ayar', 'settings'], ikon: 'ayarlar' },
  { anahtarlar: ['ara', 'search', 'analiz'], ikon: 'arama' },
  { anahtarlar: ['monitor', 'masaustu', 'masaüstü', 'desktop'], ikon: 'masaustu' },
  ...
  { anahtarlar: ['eposta', 'e-posta', 'email', 'mail'], ikon: 'eposta' },
  ...
  { anahtarlar: ['guvenlik', 'güvenlik', 'kalkan', 'shield', 'security'], ikon: 'guvenlik' },
