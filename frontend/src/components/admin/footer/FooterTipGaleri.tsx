...
const GALERI_KATEGORILER: { id: string; etiket: string; ids: FooterTipi[] | null }[] = [
  ...
  { id: 'eticaret', etiket: 'E-ticaret', ids: ['klasik', 'magaza', 'detayli'] },
  { id: 'kurumsal', etiket: 'Kurumsal', ids: ['kurumsal', 'newsletter'] },
  { id: 'minimal', etiket: 'Minimal', ids: ['sade', 'merkezi', 'kompakt'] },
];
