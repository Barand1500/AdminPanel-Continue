...
export const WIDGET_TIPLERI = [
  ...
  { id: 'SITE_HAKKINDA', etiket: 'Kurumsal Tanıtım / Hakkımızda', ikon: '🏢', aciklama: 'Hakkımızda metni, özellik kartları, görsel ve video CTA', grup: 'İçerik', kategori: 'resim_metin' as const },
  ...
  { id: 'GORSEL_ETIKET_KARTLARI', etiket: 'Ürün / Görsel Kartları', ikon: '🖼️', aciklama: 'Ürün vitrini veya görsel ürün grubu kartları', grup: 'İçerik', kategori: 'kart' as const },
  ...
  { id: 'MARKA_SERIDI', etiket: 'Marka Şeridi', ikon: '🏷️', aciklama: 'Logo kart karuseli veya kayan partner şeridi', grup: 'Modern', kategori: 'modern' as const },
  ...
  { id: 'ILETISIM_BLOK', etiket: 'İletişim + Harita', ikon: '📍', aciklama: 'İletişim kartları ve harita', grup: 'İletişim', kategori: 'iletisim' as const },
