...
export const footerAyarlariSchema = z.object({
  ...
  tipEk: z
    .object({
      ...
      arkaPlanSaydamlik: z.number().min(0).max(1).optional(),
      gradientEtkin: z.boolean().optional(),
      gradientBitisRengi: z.string().max(20).optional(),
      altBantGradientBitisRengi: z.string().max(20).optional(),
      gradientAcisi: z.number().min(0).max(360).optional(),
